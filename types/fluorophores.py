...
class Fluorophores(NewEnum):
    ...
    r800      = 'Rhodamine 800',                              'C1CC2=CC3=C(C4=C2N(C1)CCC4)OC5=C6CCC[N+]7=C6C(=CC5=C3C#N)CCC7',                   (0,0),   113302, Solvents.etoh,   682,   0.25,    Solvents.etoh,  623,   1.93,  Solvents.etoh,  False, True,  False,  +1
    #                                                                                                                                                     10.1002/marc.201900234 (SI)     10.1002/marc.201900234 (SI)     10.1016/1010-6030(92)85181-S
    aaq       = '1-Aminoanthraquinone',                       'C1=CC=C2C(=C1)C(=O)C3=C(C2=O)C(=CC=C3)N',                                         (0,0),   7380,   Solvents.acn,    465,   0.031,   Solvents.chcl3, 300,   2.10,  Solvents.none,  False, True,  False
    #                                                                                                                                                                                                                     Multiexponential fit also had 30% 1.27 ns
    #                                                                                                                                                                                     10.1021/ac101329h               10.1063/1.3276680
    c153      = 'Coumarin 153',                               'C1CC2=CC3=C(C4=C2N(C1)CCC4)OC(=O)C=C3C(F)(F)F',                                   (0,0),   0,      Solvents.none,   000,   0.54,    Solvents.dcm,   402,   0.12,  Solvents.acn,   False, True,  True    
    #                                                                                                                                                     10.1021/ac60235a020             10.1021/jo061369v               10.1117/1.JBO.20.9.096002
    nr        = 'Nile Red',                                   'O=C1C=C2OC(C=C(N(CC)CC)C=C3)=C3N=C2C4=C1C=CC=C4',                                 (0,0),   38000,  Solvents.dox,    519,   0.38,    Solvents.meoh,  553,   3.656, Solvents.etoh,  False, True,  False
    #                                                                                                                                                                                     0.93 toluene
    #                       `                                                                                                           `                 10.1021/acs.joc.5b00691         10.1007/s43630-022-00250-y      10.1021/jp0525078
    bod493    = 'BODIPY 493/503',                             'Cc1c2N(c(C)c1)[B-](F)(F)[N+]1c([C]2C)c(cc1C)C',                                   (0,0),   97100,  Solvents.tol,    500,   0.968,   Solvents.tol,   500,   5.6,   Solvents.tol,   False, True,  False
    #                                                                                                                                                  10.1016/j.dyepig.2015.11.007 (SI)  10.1016/j.dyepig.2015.11.007 (SI)   
    nda       = 'Naphthalamide',                              'O=C1C=2C=CC=C3C(O)=CC=C(C(=O)N1CCC)C32',                                          (0,0),   10000,  Solvents.dmso,   378,   0.77,    Solvents.dmso,  554,   0.00,  Solvents.none,  False, True,  False
    ...
    dapi      = 'DAPI',                                       'N=C(C1=CC2=C(C=C1)C=C(C3=CC=C(C(N)=N)C=C3)N2)N',                                  (0,0),   27000,  Solvents.dmso,   333,   0.58,    Solvents.dmso,  310,   2.81,  Solvents.h2o,   False, True,  False  
    #                                                                                                                                                                                     10.1016/0003-2697(92)90003-P   10.1016/0003-2697(92)90003-P
    daa       = 'Dansyl amide',                               'CN(C)C1=CC=CC2=C1C=CC=C2S(=O)(=O)N',                                              (0,0),   0,      Solvents.none,   000,   0.39,    Solvents.etoh,  000,  17.1,   Solvents.etoh,  False, True,  False
    #                                                                                                                                                     10.1021/ja980508q               10.1021/ja980508q               10.1021/ja980508q
    bsc       = 'Boron Subphthalocyanine Chloride',           'B1(N2C3=C4C=CC=CC4=C2N=C5N1C(=NC6=NC(=N3)C7=CC=CC=C76)C8=CC=CC=C85)Cl',           (0,0),   63000,  Solvents.tol,    569,   0.25,    Solvents.tol,   000,   3.3,   Solvents.tol,   False, True,  False
    #                                                                                                                                                                                     10.1039/c4cc09206f              10.1039/c4cc09206f
    asp       = 'α-Sexithiophene',                            'c1csc(c1)-c2ccc(s2)-c3ccc(s3)-c4ccc(s4)-c5ccc(s5)-c6cccs6',                       (0,0),   0,      Solvents.none,   000,   0.41,    Solvents.dcm,   436,   1.0,   Solvents.dcm,   False, True,  False



    # Gas DS
    r575      = 'Rhodamine 575',                              'CCNc1cc2OC3=CC(=[N+]/CC)\C(C)=CC3=C(c2cc1C)c4ccccc4C([O-])=O',                    (0,0),   0,      Solvents.none,   000,   0.00,    Solvents.none,  000,   0.00,  Solvents.none,  False, False, True
    fl        = 'Fluorescein',                                'c1ccc2c(c1)C(=O)OC23c4ccc(cc4Oc5c3ccc(c5)O)O',                                    (0,0),   0,      Solvents.none,   000,   0.00,    Solvents.none,  000,   0.00,  Solvents.none,  False, False, True
    bod8m     = '8-methoxy BODIPY',                           'c1c2N(cc1)[B-](F)(F)[N+]1c([C]2(OC))c(cc1)',                                      (0,0),   0,      Solvents.none,   000,   0.00,    Solvents.none,  000,   0.00,  Solvents.none,  False, False, True

...
class Fluorophores(NewEnum):
    ...
    pro       = 'Prodan',                                     'CCC(=O)C1=CC2=C(C=C1)C=C(C=C2)N(C)C',                                                                                 (0,0),   True,  True
    ...
    bod493    = 'BODIPY 493/503',                             'Cc1c2N(c(C)c1)[B-](F)(F)[N+]1c([C]2C)c(cc1C)C',                                                                       (0,0),   True,  True
    ...
    daa       = 'Dansyl amide',                               'CN(C)C1=CC=CC2=C1C=CC=C2S(=O)(=O)N',                                                                                  (0,0),   True,  True
    ...
    ai        = '7-Azaindole',                                'C1=CC2=C(NC=C2)N=C1',                                                                                                 (0,0),   False, True

    # possible?
    c120      = 'Coumarin 120?',                              'CC1=CC(=O)OC2=C1C=CC(=C2)N',                                                                                          (0,0),   False, True

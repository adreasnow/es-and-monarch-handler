...
class Fluorophores(NewEnum):
    ...
    az        = 'Azulene',                                    'c1cccc2cccc2c1',                                                                  (8,8),   0,      Solvents.none,   000,   0.24,    Solvents.meoh,  347,   5,     Solvents.meoh,  False, True,  True,    0, States.s2
    ...
    aaq       = '1-Aminoanthraquinone',                       'C1=CC=C2C(=C1)C(=O)C3=C(C2=O)C(=CC=C3)N',                                         (8,8),   7380,   Solvents.acn,    465,   0.07,    Solvents.nhex,  450,   2.10,  Solvents.chcl3, False, True,  False
    ...
    c153      = 'Coumarin 153',                               'C1CC2=CC3=C(C4=C2N(C1)CCC4)OC(=O)C=C3C(F)(F)F',                                   (8,8),   0,      Solvents.none,   000,   0.90,    Solvents.chex,  393,   4.3,   Solvents.meoh,  False, True,  True    
    ...
    bod493    = 'BODIPY 493/503',                             'Cc1c2N(c(C)c1)[B-](F)(F)[N+]1c([C]2C)c(cc1C)C',                                   (10,10), 97100,  Solvents.tol,    500,   0.968,   Solvents.tol,   450,   5.6,   Solvents.tol,   False, True,  False
    #                                                                                                                                                                               10.1039/d0cc01251c (SI)
    nda       = 'N-methoxyethyl-4-methoxy-1,8-naphthalimide', 'C1=CC2C3C(C(=O)N(CCOC)C2=O)=CC=CC3=C1OC',                                         (10,10), 0    ,  Solvents.dmso,   367,   0.47,    Solvents.dmso,  367,   0.00,  Solvents.none,  False, True,  False
    ...
    dapi      = 'DAPI',                                       'N=C(C1=CC2=C(C=C1)C=C(C3=CC=C(C(N)=N)C=C3)N2)N',                                  (14,14), 27000,  Solvents.dmso,   333,   0.58,    Solvents.dmso,  310,   2.81,  Solvents.h2o,   False, True,  False
    #                                                                                                                                                                                     10.1016/0003-2697(92)90003-P   10.1021/ja00844a033 (from 1974...)
    daa       = 'Dansyl amide',                               'CN(C)C1=CC=CC2=C1C=CC=C2S(=O)(=O)N',                                              (8,7),   0,      Solvents.none,   000,   0.39,    Solvents.etoh,  000,  17.1,   Solvents.etoh,  False, True,  False
    ...
    rb        = 'Rhodamine B',                                'CC/[N+](CC)=C1C=CC2=C(C3=CC=CC=C3C(O)=O)C4=C(C=C(N(CC)CC)C=C4)OC2=C\\1',          (0,0),   106000, Solvents.etoh,   543,   0.7,     Solvents.meoh,  348,   2.5 ,  Solvents.meoh,  True,  False, False,  +1

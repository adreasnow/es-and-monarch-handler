...
class Fluorophores(NewEnum):
    ...
    bod493    = 'BODIPY 493/503',                             'Cc1c2N(c(C)c1)[B-](F)(F)[N+]1c([C]2C)c(cc1C)C',                                   (8,8),   97100,  Solvents.tol,    500,   0.968,   Solvents.tol,   450,   5.6,   Solvents.tol,   False, True,  False
    ...
    bsc       = 'Boron Subphthalocyanine Chloride',           'B1(N2C3=C4C=CC=CC4=C2N=C5N1C(=NC6=NC(=N3)C7=CC=CC=C76)C8=CC=CC=C85)Cl',           (6,5),   63000,  Solvents.tol,    569,   0.25,    Solvents.tol,   000,   3.3,   Solvents.tol,   False, True,  False

...
class Methods(NewEnum):
    ...
    caspt2      = 'CASPT2',           'CASSCF',           None,                              None,        None,        None,        Rank.cas,          False,   Dispersion.none,   Spin_Scaling.none,   False
    nevpt2      = 'NEVPT2',           'CASSCF',           None,                              None,        None,        None,        Rank.cas,          False,   Dispersion.none,   Spin_Scaling.none,   False

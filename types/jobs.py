...
class MetaJobs(NewEnum):
    ...
    or_wb_sp_eq_tz     = 'orca wb es neq tz',               Software.orca,    Jobs.sp,          Methods.wb97xd,     Basis.augccpvtz,   Grids.g99_590,   TDDFT.tddft,    PCM.smd,   PCM.Eq.eq,      PCM.ExcitedModel.lr,    4,   False,  True,  True,  False,   TDDFT.Triplets.off,   PCM.Formalism.none,      PCM.Discretisation.default,     PCM.Radii.default,   1.2,    0.0,      PCM.Cavity.default,    0,        False
    or_cb_sp_eq_tz     = 'orca cb es neq tz',               Software.orca,    Jobs.sp,          Methods.cb3lyp,     Basis.augccpvtz,   Grids.g99_590,   TDDFT.tddft,    PCM.smd,   PCM.Eq.eq,      PCM.ExcitedModel.lr,    4,   False,  True,  True,  False,   TDDFT.Triplets.off,   PCM.Formalism.none,      PCM.Discretisation.default,     PCM.Radii.default,   1.2,    0.0,      PCM.Cavity.default,    0,        False

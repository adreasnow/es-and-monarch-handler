...
class MetaJobs(NewEnum):
    ...
    # esd
    or_wb_esd          = 'orca wb esd',                     Software.orca,    Jobs.esd,         Methods.wb97xd,     Basis.augccpvdz,   Grids.g99_590,   TDDFT.tddft,    PCM.smd,   PCM.Eq.neq,     PCM.ExcitedModel.lr,    2,   True,   True,  True,  False,   TDDFT.Triplets.off,   PCM.Formalism.none,      PCM.Discretisation.default,     PCM.Radii.default,   1.2,    0.0,      PCM.Cavity.default,    0,        False
    or_cb_esd          = 'orca cb esd',                     Software.orca,    Jobs.esd,         Methods.cb3lyp,     Basis.augccpvdz,   Grids.g99_590,   TDDFT.tddft,    PCM.smd,   PCM.Eq.neq,     PCM.ExcitedModel.lr,    2,   True,   True,  True,  False,   TDDFT.Triplets.off,   PCM.Formalism.none,      PCM.Discretisation.default,     PCM.Radii.default,   1.2,    0.0,      PCM.Cavity.default,    0,        False
